...
what models/analysis were you thinking of carry on
if you have already read some literature on the topic, please list the references.
...
def create_ipdf_overlay(options_df, current_price):
    ...
    for idx, exp in enumerate(expirations[:8]):
        ...
        if len(atm_option) > 0:
            ...
            price_range, pdf = calculate_probability_distribution(
                current_price, current_price, iv, days_to_exp, risk_free_rate = r
            )
...
10. [Implied risk-neutral distribution as a closed-form function of the volatility smile | Request PDF](https://www.researchgate.net/publication/229047196_Implied_risk-neutral_distribution_as_a_closed-form_function_of_the_volatility_smile)
11. [Smile&Smirk_v11_2021.pdf - City Research Online](https://openaccess.city.ac.uk/id/eprint/26594/1/Smile%26Smirk_v11_2021.pdf)
