...
def create_ipdf_overlay(options_df, current_price, ticker = "IDK"):
    ...
    ax.set_title(f'{ticker} - Implied Probability Distribution Functions - Overlay View', 
                 fontsize=14, fontweight='bold')
    ax.set_xlabel('Stock Price', fontsize=12)
    ax.set_ylabel('Probability Density', fontsize=12)
    ax.legend(loc='upper right', fontsize=9)
    ax.grid(True, alpha=0.3)
    fig.text(1, 0, s= f'for: {ticker}', ha = "right")
    plt.tight_layout()
...
#| include: false
import winsound
winsound.PlaySound("C:/Offline_Projects/beep.wav", winsound.SND_FILENAME)
winsound.Beep(2000, 2000)   # A5 note for 0.2s
1
```
